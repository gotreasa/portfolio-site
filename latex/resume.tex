...
\tagline{Technical coach with a background in leading software development teams and architecting applications. Working on large scale transformation through working 
with teams to improve the fundamentals which makes lasting change to the culture of software development.}
